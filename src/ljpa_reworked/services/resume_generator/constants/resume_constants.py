...
NAME_PARAGRAPH_STYLE = ParagraphStyle(
    "name_paragraph", fontName=GARAMOND_SEMIBOLD, fontSize=16
)
CONTACT_PARAGRAPH_STYLE = ParagraphStyle(
    "contact_paragraph", fontName=GARAMOND_REGULAR, fontSize=12
)
...
COMPANY_HEADING_PARAGRAPH_STYLE = ParagraphStyle(
    "company_heading_paragraph", fontName=GARAMOND_SEMIBOLD, fontSize=12
)
COMPANY_TITLE_PARAGRAPH_STYLE = ParagraphStyle(
    "company_title_paragraph", fontName=GARAMOND_REGULAR, fontSize=11
)
...
def appendSectionTableStyle(table_styles: list, running_row_index: list) -> None:
    table_styles.append(
        ("TOPPADDING", (0, running_row_index[0]), (1, running_row_index[0]), 5)
    )
    table_styles.append(
        ("BOTTOMPADDING", (0, running_row_index[0]), (1, running_row_index[0]), 5)
    )
    table_styles.append(
        (
            "LINEBELOW",
            (0, running_row_index[0]),
            (-1, running_row_index[0]),
            1,
            colors.black,
        )
    )
