...
def test_static_profile_overlay_rejects_llm_static_fact_omissions():
    ...
    base = {
        "personal_info": {"name": "Ivan", "email": "i@example.com", "phone": "1", "location": "A"},
        "experience": [{"company": "TCO", "title": "PLC Engineer", "location": "A", "start_date": "2021", "end_date": "Present"}],
        "education": [{"institution": "University", "course": "MSc", "start_date": "2013", "end_date": "2019"}],
    }
    llm = {"summary": "Tailored summary", "skills": [], "experience": [{"description": ["One", "Two", "Three"]}], "education": [], "projects": [], "certifications": []}
...
def test_static_profile_overlay_uses_profile_bullets_when_llm_omits_experience():
    ...
    static = {"personal_info": {}, "education": [], "experience": [{
        "company": "TCO", "title": "PLC Engineer", "location": "A",
        "start_date": "2021", "end_date": "Present", "description": ["One", "Two", "Three"],
    }]}
    assert merge_static_resume_profile({"experience": []}, static)["experience"][0]["description"] == ["One", "Two", "Three"]
