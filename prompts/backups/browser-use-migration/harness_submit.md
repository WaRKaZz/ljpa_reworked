...
3. **Context & active page**: Use the existing CDP context and active page. After a click or redirect, re-inspect tabs and select the application tab.
...
5. **Tab teardown**: Before completing execution, close only application tabs created by this run. Do not close pre-existing browser tabs.
